...
import time
import sys
from models.network_xkanfuse import XKanFuse as net
...
def main():
    ...
    parser.add_argument('--model_path', type=str,
                        default='./Model/Medical_Fusion_CT-MRI/Medical_Fusion/models/')
    parser.add_argument('--iter_number', type=str,
                        default='7000')
    parser.add_argument('--root_path', type=str, default='./Test_image/',
                        help='input test image root folder')
    parser.add_argument('--dataset', type=str, default='CT-MRI',
                        help='input test image name')
    parser.add_argument('--A_dir', type=str, default='MRI',
                        help='input test image name')
    parser.add_argument('--B_dir', type=str, default='CT',
                        help='input test image name')
...
def define_model(args):
    model = net(upscale=args.scale, in_chans=args.in_channel, img_size=256, window_size=8,
...
def setup(args):   
    # save_dir = f'results/64/64-1000_{args.dataset}'
    save_dir = f'./Results'
