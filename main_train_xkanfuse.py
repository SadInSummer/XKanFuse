...
def main(json_path='options/swin/train_xkanfuse_med.json'):
    ...
    # ----------------------------------------
    # Train from scratch
    init_iter_G, init_path_G = None, None
    opt['path']['pretrained_netG'] = init_path_G  # The path of the pretrained model
    init_iter_optimizerG, init_path_optimizerG = None, None  # The path of the pre-trained optimizer
